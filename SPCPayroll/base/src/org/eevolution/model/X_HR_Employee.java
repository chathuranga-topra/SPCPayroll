...
public class X_HR_Employee extends PO implements I_HR_Employee, I_Persistent 
{
	...
	/** Category AD_Reference_ID=1000010 */
	public static final int CATEGORY_AD_Reference_ID=1000010;
	/** Permanent = PE */
	public static final String CATEGORY_Permanent = "PE";
	/** Contract = CO */
	public static final String CATEGORY_Contract = "CO";
	/** Casual = CA */
	public static final String CATEGORY_Casual = "CA";
	/** Trainee = TR */
	public static final String CATEGORY_Trainee = "TR";
	/** Set Category.
	...
	/** Set EPF ETF Liable.
		@param EPFETFLiable EPF ETF Liable	  */
	public void setEPFETFLiable (boolean EPFETFLiable)
	{
		set_Value (COLUMNNAME_EPFETFLiable, Boolean.valueOf(EPFETFLiable));
	}

	/** Get EPF ETF Liable.
		@return EPF ETF Liable	  */
	public boolean isEPFETFLiable () 
	{
		Object oo = get_Value(COLUMNNAME_EPFETFLiable);
		if (oo != null) 
		{
	...
	/** Set Division.
		@param HR_Division_ID Division	  */
	public void setHR_Division_ID (int HR_Division_ID)
	{
		if (HR_Division_ID < 1) 
			set_Value (COLUMNNAME_HR_Division_ID, null);
		else 
			set_Value (COLUMNNAME_HR_Division_ID, Integer.valueOf(HR_Division_ID));
	}

	/** Get Division.
		@return Division	  */
	public int getHR_Division_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Division_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		if (HR_Union_ID < 1) 
			set_Value (COLUMNNAME_HR_Union_ID, null);
		else 
			set_Value (COLUMNNAME_HR_Union_ID, Integer.valueOf(HR_Union_ID));
	}
