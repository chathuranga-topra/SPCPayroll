...
public interface I_HR_Concept 
{
    ...
    /** Column name AnnualTax */
    public static final String COLUMNNAME_AnnualTax = "AnnualTax";
    ...
    public static final String COLUMNNAME_IsSeparate = "IsSeparate";
    ...
    /** Column name LumpSumTax */
    public static final String COLUMNNAME_LumpSumTax = "LumpSumTax";
    ...
    /** Column name NoPay */
    public static final String COLUMNNAME_NoPay = "NoPay";
    ...
    /** Column name NoPayConcept_ID */
    public static final String COLUMNNAME_NoPayConcept_ID = "NoPayConcept_ID";
    ...
    /** Column name PayeeTax */
    public static final String COLUMNNAME_PayeeTax = "PayeeTax";
