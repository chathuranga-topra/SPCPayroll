...
public class X_HR_Concept extends PO implements I_HR_Concept, I_Persistent 
{
	...
	/** Set Annual Tax.
		@param AnnualTax Annual Tax	  */
	public void setAnnualTax (boolean AnnualTax)
	{
		set_Value (COLUMNNAME_AnnualTax, Boolean.valueOf(AnnualTax));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_AnnualTax);
		if (oo != null) 
		{
	...
	/** Set Separate.
		@param IsSeparate Separate	  */
	public void setIsSeparate (boolean IsSeparate)
	{
		set_Value (COLUMNNAME_IsSeparate, Boolean.valueOf(IsSeparate));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsSeparate);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Lump Sum Tax.
		@param LumpSumTax Lump Sum Tax	  */
	public void setLumpSumTax (boolean LumpSumTax)
	{
		set_Value (COLUMNNAME_LumpSumTax, Boolean.valueOf(LumpSumTax));
	}

	/** Get Lump Sum Tax.
		@return Lump Sum Tax	  */
	public boolean isLumpSumTax () 
	{
		Object oo = get_Value(COLUMNNAME_LumpSumTax);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_NoPay, Boolean.valueOf(NoPay));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_NoPay);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set PAYE Tax.
		@param PayeeTax PAYE Tax	  */
	public void setPayeeTax (boolean PayeeTax)
	{
		set_Value (COLUMNNAME_PayeeTax, Boolean.valueOf(PayeeTax));
	}

	/** Get PAYE Tax.
		@return PAYE Tax	  */
	public boolean isPayeeTax () 
	{
		Object oo = get_Value(COLUMNNAME_PayeeTax);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
