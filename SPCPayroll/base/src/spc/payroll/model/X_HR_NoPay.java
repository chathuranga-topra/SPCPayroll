...
/** Generated Model for HR_NoPay
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_HR_NoPay extends PO implements I_HR_NoPay, I_Persistent 
{
    ...
    public X_HR_NoPay (Properties ctx, int HR_NoPay_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_HR_NoPay (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_NoPay[")
	...
	{
		if (HR_NoPay_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_NoPay_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_NoPay_ID, Integer.valueOf(HR_NoPay_ID));
	}
	...
	/** Set Month Work Days.
		@param MonthWorkDays Month Work Days	  */
	public void setMonthWorkDays (int MonthWorkDays)
	{
		set_Value (COLUMNNAME_MonthWorkDays, Integer.valueOf(MonthWorkDays));
	}

	/** Get Month Work Days.
		@return Month Work Days	  */
	public int getMonthWorkDays () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_MonthWorkDays);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
