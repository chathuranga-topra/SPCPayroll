...
/** Generated Model for HR_OtCategory
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_HR_OtCategory extends PO implements I_HR_OtCategory, I_Persistent 
{
    ...
    public X_HR_OtCategory (Properties ctx, int HR_OtCategory_ID, String trxName)
    {
      super (ctx, HR_OtCategory_ID, trxName);
      /** if (HR_OtCategory_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_HR_OtCategory (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_OtCategory[")
	...
	public void setHR_OtCategory_ID (int HR_OtCategory_ID)
	{
		if (HR_OtCategory_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_OtCategory_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_OtCategory_ID, Integer.valueOf(HR_OtCategory_ID));
	}
